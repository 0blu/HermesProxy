namespace HermesProxy.World.Enums.V2_5_4_42695
{
    public enum Opcode : uint
    {
        ...
        CMSG_ACCOUNT_NOTIFICATION_ACKNOWLEDGED                       = 0x373A,
        ...
        CMSG_ARENA_TEAM_ACCEPT                                       = 0x36B6,
        CMSG_ARENA_TEAM_DECLINE                                      = 0x36B7,
        CMSG_ARENA_TEAM_DISBAND                                      = 0x36BA,
        CMSG_ARENA_TEAM_LEADER                                       = 0x36BB,
        CMSG_ARENA_TEAM_LEAVE                                        = 0x36B8,
        CMSG_ARENA_TEAM_QUERY                                        = 0x36A2,
        CMSG_ARENA_TEAM_REMOVE                                       = 0x36B9,
        CMSG_ARENA_TEAM_ROSTER                                       = 0x36B5,
        ...
        CMSG_AUCTION_SET_FAVORITE_ITEM                               = 0x373B,
        ...
        CMSG_BATTLEMASTER_JOIN_BRAWL                                 = 0x3523,
        ...
        CMSG_BATTLE_PAY_CANCEL_OPEN_CHECKOUT                         = 0x3718,
        ...
        CMSG_BATTLE_PAY_OPEN_CHECKOUT                                = 0x3711,
        CMSG_BATTLE_PAY_REQUEST_PRICE_INFO                           = 0x370D,
        ...
        CMSG_BLACK_MARKET_BID_ON_ITEM                                = 0x352D,
        CMSG_BLACK_MARKET_OPEN                                       = 0x352B,
        CMSG_BLACK_MARKET_REQUEST_ITEMS                              = 0x352C,
        ...
        CMSG_CLIENT_PORT_GRAVEYARD                                   = 0x3527,
        ...
        CMSG_CLUB_FINDER_REQUEST_CLUBS_DATA                          = 0x3725,
        CMSG_CLUB_FINDER_REQUEST_CLUBS_LIST                          = 0x371F,
        CMSG_CLUB_FINDER_REQUEST_MEMBERSHIP_TO_CLUB                  = 0x3720,
        CMSG_CLUB_FINDER_REQUEST_PENDING_CLUBS_LIST                  = 0x3724,
        CMSG_CLUB_FINDER_REQUEST_SUBSCRIBED_CLUB_POSTING_IDS         = 0x3726,
        CMSG_CLUB_FINDER_RESPOND_TO_APPLICANT                        = 0x3722,
        CMSG_CLUB_PRESENCE_SUBSCRIBE                                 = 0x36FC,
        ...
        CMSG_CONTRIBUTION_LAST_UPDATE_REQUEST                        = 0x3558,
        CMSG_CONVERSATION_CINEMATIC_READY                            = 0x3547,
        CMSG_CONVERSATION_LINE_STARTED                               = 0x3546,
        ...
        CMSG_ITEM_PURCHASE_REFUND                                    = 0x3530,
        ...
        CMSG_MOVE_APPLY_INERTIA_ACK                                  = 0x3A4B,
        ...
        CMSG_MOVE_REMOVE_INERTIA_ACK                                 = 0x3A4C,
        ...
        CMSG_PLAYER_SHOWING_CLOAK                                    = 0x3566,
        CMSG_PLAYER_SHOWING_HELM                                     = 0x3565,
        ...
        CMSG_QUERY_GARRISON_PET_NAME                                 = 0x3272,
        ...
        CMSG_QUEST_SESSION_REQUEST_STOP                              = 0x3732,
        CMSG_QUEUED_MESSAGES_END                                     = 0x376C,
        CMSG_QUICK_JOIN_AUTO_ACCEPT_REQUESTS                         = 0x370B,
        CMSG_QUICK_JOIN_REQUEST_INVITE_WITH_CONFIRMATION             = 0x3737,
        CMSG_QUICK_JOIN_RESPOND_TO_INVITE                            = 0x370A,
        CMSG_QUICK_JOIN_SIGNAL_TOAST_DISPLAYED                       = 0x3709,
        CMSG_RAF_CLAIM_NEXT_REWARD                                   = 0x3728,
        CMSG_RAF_GENERATE_RECRUITMENT_LINK                           = 0x372A,
        CMSG_RAF_UPDATE_RECRUITMENT_INFO                             = 0x3729,
        ...
        CMSG_REMOVE_RAF_RECRUIT                                      = 0x372B,
        ...
        CMSG_SET_LOOT_SPECIALIZATION                                 = 0x353F,
        ...
        CMSG_START_CHALLENGE_MODE                                    = 0x354A,
        ...
        CMSG_VAS_CHECK_TRANSFER_OK                                   = 0x3710,
        CMSG_VAS_GET_QUEUE_MINUTES                                   = 0x370F,
        CMSG_VAS_GET_SERVICE_STATUS                                  = 0x370E,
        CMSG_VIOLENCE_LEVEL                                          = 0x3188,
        CMSG_VOICE_CHANNEL_STT_TOKEN_REQUEST                         = 0x3714,
        CMSG_VOICE_CHAT_JOIN_CHANNEL                                 = 0x3715,
        CMSG_VOICE_CHAT_LOGIN                                        = 0x3713,
        ...
        SMSG_ACCOUNT_TRANSMOG_SET_FAVORITES_UPDATE                   = 0x25B1,
        SMSG_ACCOUNT_TRANSMOG_UPDATE                                 = 0x25B0,
        ...
        SMSG_AZERITE_RESPEC_NPC                                      = 0x27F1,
        ...
        SMSG_CHROMIE_TIME_OPEN_NPC                                   = 0x27F6,
        SMSG_CHROMIE_TIME_SELECT_EXPANSION_SUCCESS                   = 0x2880,
        ...
        SMSG_CONVERT_ITEMS_TO_CURRENCY_VALUE                         = 0x2889,
        ...
        SMSG_ISLANDS_MISSION_NPC                                     = 0x27F3,
        ...
        SMSG_ITEM_INTERACTION_COMPLETE                               = 0x287F,
        ...
        SMSG_LEVEL_LINKING_RESULT                                    = 0x2864,
        ...
        SMSG_MOVE_FORCE_ROOT                                         = 0x2DF9,
        SMSG_MOVE_FORCE_UNROOT                                       = 0x2DFA,
        ...
        SMSG_PVP_MATCH_COMPLETE                                      = 0x2952,
        ...
        SMSG_QUEST_SESSION_INFO_RESPONSE                             = 0x287A,
        ...
        SMSG_RESTRICTED_ACCOUNT_WARNING                              = 0x25B6,
        ...
        SMSG_SPLASH_SCREEN_SHOW_LATEST                               = 0x2881,
        ...
        SMSG_TOTEM_DURATION_CHANGED                                  = 0x269B,
        ...
        SMSG_UI_ITEM_INTERACTION_NPC                                 = 0x27F2,
        ...
        SMSG_WEATHER                                                 = 0x269D,
        SMSG_WEEKLY_REWARDS_PROGRESS_RESULT                          = 0x2884,
        SMSG_WEEKLY_REWARDS_RESULT                                   = 0x2882,
        SMSG_WEEKLY_REWARD_CLAIM_RESULT                              = 0x2883,
        SMSG_WEEKLY_SPELL_USAGE                                      = 0x2C18,
        SMSG_WHO                                                     = 0x2BAE,
        SMSG_WHO_IS                                                  = 0x269C,
        SMSG_WILL_BE_KICKED_FOR_ADDED_SUBSCRIPTION_TIME              = 0x281E,
        SMSG_WORLD_MAP_OPEN_NPC                                      = 0x27EF,
